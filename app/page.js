...
export default function Home() {
  return (
    <article>
      <header className="flex items-center h-svh px-5 lg:px-20 bg-slate-500 bg-[url('')] bg-blend-overlay">
        <div className="flex flex-col items-center gap-3 text-center lg:items-start lg:w-1/2 lg:text-left">
      ...
      <section className="py-10 px-5 lg:px-20">
        ...
        {/* card container */}
        <div className="flex overflow-x-hidden items-center gap-4">
          <CourseCard>
