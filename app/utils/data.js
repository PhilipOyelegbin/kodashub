...
export const Courses = [
    ...
    },
    {
        ...
        description: "Backend development using Django involves building robust, scalable, and maintainable web applications using the Django framework. Django provides a high-level Python web framework that enables rapid development and clean, pragmatic design. Django's batteries-included approach provides a comprehensive set of tools and libraries, making it an ideal choice for building complex and scalable web applications quickly and efficiently. Its strong emphasis on reusability, modularity, and maintainability ensures that applications built with Django are robust and long-lasting.",
        cover_image: "/course_banner.jpg", 
        price: "₦150,000", 
        url:"", 
    ...
    },
    {
        ...
        description: "Cyber security refers to the practices, technologies, and processes designed to protect digital information, networks, and systems from unauthorized access, use, disclosure, disruption, modification, or destruction. This includes protection against malware, viruses, hacking, phishing, and other types of cyber threats. Effective cyber security measures enable organizations and individuals to safeguard their sensitive data, maintain confidentiality, integrity, and availability, and ensure business continuity. Key aspects of cyber security include: Network security, Application security, Data security, Endpoint security, etc. In today's interconnected world, cyber security is crucial for protecting against financial loss, reputational damage, and potential physical harm.",
        cover_image: "/course_banner.jpg", 
        price: "₦200,000", 
        url:"", 
    ...
    {
        title: "Data Science", 
        description: "Data science is the extraction of insights and knowledge from data using various techniques, tools, and methods. Data science combines elements of computer science, statistics, and domain expertise. The goal of data science is to turn data into actionable knowledge that drives business value and informs strategic decisions.",
        cover_image: "/course_banner.jpg", 
        price: "₦150,000", 
        url:"", 
        prerequisite: "Knowledge of basic computer skills.", 
    ...
    {
        title: "Data Analysis", 
        description: "Data analysis is the process of extracting insights and meaningful patterns from data to support decision-making, problem-solving, and business improvement. The goal of data analysis is to turn data into actionable knowledge that drives business value and improvement.",
        cover_image: "/course_banner.jpg", 
        price: "₦120,000", 
        url:"", 
        prerequisite: "Knowledge of basic computer skills.", 
...
export const Testimonials = [
    {
        name: "Natasha Morris", 
        summary: "KodasHub have great instructors who knows their onions at their disposal.", 
